...
### HealthReportExtensions.TryGetHealthy method
</br>
...
```csharp
public static bool TryGetHealthy(this HealthReport report, 
...
| result | the Dictionary with all HealthCheck Result with healthy status |
