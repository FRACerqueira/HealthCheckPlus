...
By contributing to **HealthCheckPlus**, you assert that:

* The contribution is your own original work.
* You have the right to assign the copyright for the work (it is not owned by your employer, or
  you have been given copyright assignment in writing).
* You [license](LICENSE.md) the contribution under the terms applied to the rest of the HealthCheckPlus project.
...
The assembly `HealthCheckPlus` should have no dependencies except the .NET BCL library.
 ...
 * Through GitHub, or through the [GitHub discussions](https://github.com/FRACerqueira/HealthCheckPlus/discussions) (preferred),
   you talk about a feature you would like to see (or a bug), and why it should be in HealthCheckPlus.
  ...
  * Alternatively, if a feature is on the issues list with the
   [Up For Grabs](https://github.com/FRACerqueira/HealthCheckPlus/labels/up-for-grabs) label,
 ...
 * You create, or update, a fork of `HealthCheckPlus` under your GitHub account.
 ...
 * Once you feel it is ready, submit the pull request to the `HealthCheckPlus` repository against the `main` branch
 ...
 * One of the HealthCheckPlus team members, or one of the maintainers, will evaluate it within a
 ...
 * `git push origin your-branch` (origin would be your GitHub repo or `your-github-username/HealthCheckPlus` in this case).
...
If you reformat code or hit core functionality without an approval from a person on the HealthCheckPlus Team,
...
with permission and was edited to follow HealthCheckPlus's conventions and processes.