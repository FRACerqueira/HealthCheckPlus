...
namespace HealthCheckPlus.Options
{
    ...
    public class HealthCheckPlusOptions : HealthCheckOptions
    {
        ...
        /// <summary>
        /// Gets or sets the Aggregate Status for HealthReport. Default value is min() of all status reported
        /// </summary>
        public Func<HealthReport, HealthStatus>? StatusHealthReport { get; set; }

        /// <summary>
        /// Gets or sets the name of Aggregate Status for HealthReport.
        /// </summary>
