    ...
    internal class Program
    {
        ...
        static int Main()
        {
            ...
            foreach (var item in files)
            {
                ...
                content[0]= "![HealthCheckPlus Logo](https://raw.githubusercontent.com/FRACerqueira/HealthCheckPlus/refs/heads/main/icon.png)";
                content[1]= "";
            ...
            foreach (var item in folders)
            {
                ...
                foreach (var item1 in itemsfolder)
                {
                    ...
                    foreach (var item2 in itemsfile)
                    {
                        ...
                        var title = content[0].Replace("# ", "");
                        content.Insert(0, "![HealthCheckPlus Logo](https://raw.githubusercontent.com/FRACerqueira/HealthCheckPlus/refs/heads/main/icon.png)");
                        content[1] = "";
                        content.Insert(2, $"### {title}");
                        content.Insert(3, "</br>");
                        content.Insert(4, "");
