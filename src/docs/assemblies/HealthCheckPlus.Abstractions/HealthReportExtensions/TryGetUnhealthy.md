...
### HealthReportExtensions.TryGetUnhealthy method
</br>
...
```csharp
public static bool TryGetUnhealthy(this HealthReport report, 
...
| result | the Dictionary with all HealthCheck Result with unhealthy status |
